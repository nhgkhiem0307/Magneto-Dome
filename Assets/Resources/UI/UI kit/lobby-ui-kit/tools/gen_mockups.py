...
SPR = "/mnt/user-data/outputs/lobby-ui-kit/sprites"
ICO = "/mnt/user-data/outputs/lobby-ui-kit/icons"
OUT = "/mnt/user-data/outputs/lobby-ui-kit/mockups"
...
def eyebrow(d, xy, s, anchor="lm"):
    text(d, xy, s.upper(), font("medium", 15), rgb(P["text_faint"]),
         anchor=anchor, spacing=2.6)
